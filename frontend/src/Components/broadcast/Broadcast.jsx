...
const Broadcast = () => {
    ...
    return (
        ...
        <div>
            ...
            <Button onClick={() => incrementSteps()}>Next Step</Button><br/><br/>
            <Typography variant='p'><span style={{fontWeight:'bold'}}>1.</span> Your livestream broadcast won't be accessible until you click the START BROADCAST button!</Typography><br/>
            <Typography variant='p' style={{paddingBottom:'20px'}}><span style={{fontWeight:'bold'}}>2.</span> When you're done with your broadcast, click DISCONNECT to remove your stream from public view and then close your tab to close your camera!</Typography><br/>
